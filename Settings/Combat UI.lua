...
local function WLXL_fake_script() -- Frame.Draggable 
...
Aimbot.MouseButton1Down:connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/countervolts/aimbot/main/aimbot.lua', true))()
end)
...
Reach.MouseButton1Down:connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/countervolts/sword-reach-script/main/swordreach.lua', true))()
end)


coroutine.wrap(WLXL_fake_script)()
